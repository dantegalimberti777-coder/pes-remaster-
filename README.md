...
Base importada desde [vi3itor/GameplayFootball](https://github.com/vi3itor/GameplayFootball), a partir de la cual se irá modificando el juego. El contenido debajo es el README original del proyecto base, útil para compilar y correr el juego tal cual mientras arrancamos.
